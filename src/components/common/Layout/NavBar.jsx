        ...
        return (
          <>
            ...
            {path.name === "About Us" && hoveredItem === "About Us" && (
              ...
              >
                <div
                  className="w-full max-w-[800px] bg-white p-16"
                  onProductClick={handleOurBrandContentClick}
                >
                  <div className="flex flex-row gap-6 justify-between">
                    ...
                    <div className="flex flex-col w-1/3 gap-4">
                      <h4 className="font-bold text-[#A57F5A] mb-2 border-l-2 border-[#9F7B49] px-2">
                        Corporate Profile
                      </h4>
                    ...
                    <div className="flex flex-col w-1/3 gap-4">
                      ...
                      <ul className="text-sm text-gray-600 space-y-4">
                        ...
                        <li>
                          <div onClick={handleContactContentClick}>
                            <Link
                              href="/contact-us/factoryAddress"
                              className="hover:underline"
                            >
                              Factory Address
                            </Link>
