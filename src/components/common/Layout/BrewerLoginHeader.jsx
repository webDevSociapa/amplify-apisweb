          ...
          >
            <div className="group">
              <svg
                ...
                viewBox="0 0 512 512"
                className="w-5 h-5 fill-current text-[#9f7b49] group-hover:text-[#1877f2] transition-colors duration-200"
              >
          ...
          >
            <div className="group">
              <svg
                ...
                style={{
                  "--default-color": "rgb(159 123 73)",
                  "--hover-color": "#000000"  // X (Twitter) now uses black
                }}
              >
                <path
          ...
          >
            <div className="group">
              <svg
                ...
                style={{
                  "--default-color": "rgb(159 123 73)",
                  "--hover-color": "#FF0000"  // YouTube's official red color
                }}
              >
                <path
          ...
          >
            <div className="group">
              <svg
                ...
                style={{
                  "--default-color": "rgb(159 123 73)",
                  "--hover-color": "#E4405F"  // Instagram's official color
                }}
              >
                <path
          ...
          >
            <div className="group">
              <svg
                ...
                style={{
                  "--default-color": "rgb(159 123 73)",
                  "--hover-color": "#0A66C2"  // LinkedIn's official blue color
                }}
              >
                <path
