    ...
    <div className="w-full bg-[#EECB9A] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-center text-3xl font-bold text-black mb-2">
          Share Your Views For AIL
        </h2>
        <p className="text-center text-lg text-black mb-8">
          Enter the following details and share your views
        </p>

        {popupMessage && (
          <div
            id="toast-success"
            className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow mt-5"
            role="alert"
          >
            ...
            <button
              onClick={closeToast}
              className="ms-auto -mx-1.5 -my-1.5 text-gray-400 hover:text-gray-900 rounded-lg p-1.5"
            >
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full p-2 border border-black rounded bg-transparent"
                required
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-2 border border-black rounded bg-transparent h-32 placeholder-black placeholder-opacity-60"
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-[#AE844A] text-white py-2 px-8 rounded font-medium hover:bg-[#835415]"
            >
              Submit
            </button>
          </div>
