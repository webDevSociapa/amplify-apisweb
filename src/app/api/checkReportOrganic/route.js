...
export async function POST(req) {
  try {
    ...
    console.log(
      `Searching for batch number: ${batch_number} in hardcoded data`
    );
    ...
    const data = [
      {
        id: "1",
        batch_number: "DS21KF255",
        packed_on: "Nov-23",
        report_no: "IFS-231230089",
        report_no1: "FA20231205-056-092\r\nAIL/FG/2916/2023",
      },
      {
        id: "2",
        batch_number: "DS28KF257",
        packed_on: "Dec-23",
        report_no: "IFS-231130088",
        report_no1: "FA20231205-056-093\r\nAIL/FG/2919/2023",
      },
      {
        id: "3",
        batch_number: "DS20AG280",
        packed_on: "Jan-24",
        report_no: "IFS-240212152R1\r\nIFS-240201007",
        report_no1: "FA20240131-077-313\r\nAIL/FG/2984/2024",
      },
      {
        id: "4",
        batch_number: "DS31AG285",
        packed_on: "Feb-24",
        report_no: "IFS-240216011",
        report_no1: "FA20240214-040-116\r\nAIL/FG/2999/2023",
      },
      {
        id: "5",
        batch_number: "DS23BG292",
        packed_on: "Feb-24",
        report_no: "IFS-240301003\r\nIFS-240301003S",
        report_no1: "FA20240305-019-056\r\nAIL/FG/3048/2024",
      },
      {
        id: "18",
        batch_number: "DS31HG043",
        packed_on: "Sept-24",
        report_no: "IFS-240902093",
        report_no1: "AIL/FG/4064/2024",
      },
      {
        id: "19",
        batch_number: "DS02LG091",
        packed_on: "Nov-24",
        report_no: "IFS-241205170",
        report_no1: "AIL/FG/4344/2024",
      },
      {
        id: "20",
        batch_number: "DS04AH099",
        packed_on: "Jan-25",
        report_no: "IFS-250108004",
        report_no1: "AIL/FG/4406/2025",
      },
      {
        id: "21",
        batch_number: "DS13BH115",
        packed_on: "Feb-25",
        report_no: "IFS-250217004",
        report_no1: "AIL/FG/4456/2025",
      },
      {
        id: "22",
        batch_number: "DS26HH057",
        packed_on: "Aug-25",
    ...
    const specificBatchData = data.find(
